...
internal static class AppConfig
{
    ...
    public static readonly double MoveReleaseThreshold = MoveThreshold * 0.6; // 已按住方向鍵時的鬆開門檻（低於觸發門檻，避免抖動連點）
    public static readonly double JumpThreshold = 1.7; // 判定跳躍的加速度門檻
    public static readonly double DownThreshold = -1.0; // 判定下蹲的加速度門檻
    public static readonly double DownReleaseThreshold = DownThreshold * 0.6; // 已按住下蹲鍵時的鬆開門檻（避免抖動連點）
